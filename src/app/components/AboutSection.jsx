...
//         </li>
//         <li className="flex items-center mb-2">
//           <span className="bg-pink-500 rounded-full w-3 h-3 mr-3"></span> Blender
//         </li>
//         <li className="flex items-center mb-2">
...
//       <ul className="list-none pl-0">
//         <li className="flex items-center mb-2">
//           <span className="bg-pink-500 rounded-full w-3 h-3 mr-3"></span> Artevelde University of Applied Sciences, Interactive Media Development
//         </li>
//       </ul>
//     ),
//   },
...
//       <ul className="list-none pl-0">
//         <li className="flex items-center mb-2">
//           <span className="bg-pink-500 rounded-full w-3 h-3 mr-3"></span> Internship at Sweet Mustard as UX/UI-Designer & Front-End Developer
//         </li>
//       </ul>
//     ),
//   },
...
//   return (
//     <section id="about-me" className="text-white py-16">
//       <div className="md:flex gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 max-w-7xl mx-auto">
//         <div className="text-left flex flex-col h-full md:w-1/2">
//           <h2 className="text-4xl font-bold mb-5">About Me</h2>
//           <p className="text-lg lg:text-xl text-gray-200 leading-relaxed">
//             Hello there! 👋 I’m Aleyna Uzuncam, a passionate programming
//             enthusiast and graphic designer. Having recently graduated, I’m
//             excited to dive deeper into the world of tech and design. For me,
//             programming isn’t just a skill; it’s my passion, my creative outlet,
//             and my ticket to shaping the digital future. With a keen eye for
//             design and a love for creating seamless user experiences, I bridge
//             the gap between functionality and aesthetics, crafting innovative
//             solutions in both the coding and design realms.
//           </p>
//         </div>
...
//         <div className="mt-8 bg-[#33353e] p-6 rounded-lg shadow-lg w-full md:w-3/4">
